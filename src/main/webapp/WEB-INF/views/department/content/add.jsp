...
<div id="departmentAddPanel">
	...
	<form class="real-content-form form" name="department" action="${ctx }/department/content/save" method="post">
		...
		<div class="form-group">
			<label class="input-label">编码</label> <input name="code" class="input-content" type="text" placeholder="请输入编码" value="${department.code }" autofocus>
		</div>
		<div class="form-group">
			<label class="input-label">名称</label> <input name="name" class="input-content" type="text" placeholder="请输入名称" value="${department.name }">
		</div>
